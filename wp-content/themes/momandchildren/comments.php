<?php
    ...
    <?php
            ...
            $comments_attr = array(
                ...
                'reply_text'        => 'Reply <i class="fa fa-reply fa-fw"></i>', // replay word
    ...
    <?php
        ...
        // comment fields
        $reply_args = array(
            'title_reply'       => 'Write A New Comment <i class="fa fa-comment fa-fw"></i>' ,
            'title_reply_to'    => 'Write a Reply <i class="fa fa-reply fa-fw"></i> To [%s] <i class="fa fa-user fa-fw"></i>',
            'cancel_reply_link' => 'Cancel <i class="fa fa-times fa-fw"></i>',
            'class_submit'      => 'btn btn-primary btn-',
